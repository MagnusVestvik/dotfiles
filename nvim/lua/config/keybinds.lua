...
-- JDTLS stuff
vim.keymap.set('n', '<leader>df', function() require'jdtls'.test_class() end, { noremap = true, silent = true })
vim.keymap.set('n', '<leader>dn', function() require'jdtls'.test_nearest_method() end, { noremap = true, silent = true })
